...
!!! tip "New here?"
    If you skipped it, the short [Key Concepts](key_concepts.md) page gives you the mental model this guide builds on. It takes two minutes and makes everything below click.

Let's start with [the idea](idea.md).
