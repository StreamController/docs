At some point the libraries used by [StreamController](https://github.com/StreamController/StreamController) will not suffice for more complex plugins and actions. You'll need to add your own dependencies. This can be done by adding a `requirements.txt` file to root directory of your plugin.
